...
public class StripedTableCellRenderer implements TableCellRenderer{
   ...
   public  static void installInColumn(JTable table, int columnIndex,
     ...
     TableCellRenderer targetRenderera = tc.getCellRenderer();
 
     // Create a new StripedTableCellRenderer and install it
     tc.setCellRenderer(new StripedTableCellRenderer(targetRenderera,
   ...
   public static void installInTable(JTable table, Color evenBack,
     ...
     for (int i = 0; i < columns; i++) {
       ...
       TableCellRenderer targetRendererb = tc.getCellRenderer();
       if (targetRendererb != null) {
         // This column has a specific renderer
         tc.setCellRenderer(new StripedTableCellRenderer(targetRendererb,
             evenBack, evenFore, oddBack, oddFore));
       } else {
